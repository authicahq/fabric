...
from fabric.core.config import (
    ConfigLoader,
    _parse_env_value,
    get_env_config,
    load_yaml_config,
...
from fabric.core.exceptions import ConfigError
...
class TestGetEnvConfig:
    ...
    def test_multiple_vars(self, monkeypatch: pytest.MonkeyPatch) -> None:
        monkeypatch.setenv("FABRIC_SOURCE_DIR", "/models")
        monkeypatch.setenv("FABRIC_LOGGING__LEVEL", "DEBUG")
    ...
    def test_ignores_non_prefixed(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setenv("FABRIC_KEY", "value2")
...
class TestConfigLoader:
    ...
    def test_env_vars_override_file(
        ...
        monkeypatch.setenv("FABRIC_SOURCE_DIR", "/env/models")
